...
def professor_offerings_list(request):
    ...
    return render(
        request,
        "courses/professor_offerings_list.html",
        {"offerings": offerings}
    )
...
def enroll_in_offering(request, offering_id):
    ...
    # Capacity check
    active_count = offering.enrollments.filter(
        status="active"
    ).count()
...
def admin_offerings_panel(request):
    ...
    return render(
        request,
        "courses/admin_offerings_panel.html",
        {
            "offerings": qs,
            "term": term or ""
        }
...
def admin_offering_create(request):
    ...
    return render(
        request,
        "courses/admin_offering_form.html",
        {
            "form": form,
            "mode": "create"
        }
...
def admin_offering_delete(request, offering_id):
    ...
    return render(
        request,
        "courses/admin_offering_confirm_delete.html",
        {
            "offering": offering
        }
    )